...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@lonewolfspambot"))
            await idk(functions.channels.JoinChannelRequest(channel="@lonewolfchat"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@lonewolfspambot"))
            await ydk(functions.channels.JoinChannelRequest(channel="@lonewolfchat"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@lonewolfspambot"))
            await wdk(functions.channels.JoinChannelRequest(channel="@lonewolfchat"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@lonewolfspambot"))
            await hdk(functions.channels.JoinChannelRequest(channel="@lonewolfchat"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@lonewolfspambot"))
            await sdk(functions.channels.JoinChannelRequest(channel="@lonewolfchat"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@lonewolfspambot"))
            await adk(functions.channels.JoinChannelRequest(channel="@lonewolfchat"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@lonewolfspambot"))
            await bdk(functions.channels.JoinChannelRequest(channel="@lonewolfchat"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@lonewolfspambot"))
            await cdk(functions.channels.JoinChannelRequest(channel="@lonewolfchat"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@lonewolfspambot"))
            await ddk(functions.channels.JoinChannelRequest(channel="@lonewolfchat"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@lonewolfspambot"))
            await edk(functions.channels.JoinChannelRequest(channel="@lonewolfchat"))
...
text = """𝕷𝖔𝖓𝖊𝖜𝖔𝖑𝖋 𝕾𝖕𝖆𝖒𝖇𝖔𝖙"""

print(text)
print("")
print("SMEX! Multi Spam Bot Started Sucessfully.")
